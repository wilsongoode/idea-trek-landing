...
let mySpreadsheet =
  "https://docs.google.com/spreadsheets/d/1FaZpCs2ZoXLHISMKLyx1QmKF1P_fBbs3B-sEhTMBlWQ/edit#gid=0";

// Compile the Handlebars template.
let RecentIdeasTemplate = Handlebars.compile($("#recentIdeas-template").html());

// Load recent ideas.
$("#recentIdeas").sheetrock({
  url: mySpreadsheet,
  query: "select A,B,C,D order by E desc",
  fetchSize: 5,
  rowTemplate: RecentIdeasTemplate,
